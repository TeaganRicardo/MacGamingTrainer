...
This document describes rules that should remain true across feature work. `PROJECT_STATUS.md` owns current product status and roadmap issue #8 owns sequencing. Current code, Git history and executed tests remain the ultimate implementation evidence.
