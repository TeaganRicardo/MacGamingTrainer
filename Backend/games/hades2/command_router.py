...
class Hades2CommandRouter:
    ...
    def dispatch(self, command, params, request_id):
        ...
        if command=='scan':
        ...
        elif command in ('status','disable_all','set_desired','set_vital','set_counter','lock_vital','set_stat','set_element','lock_element','set_resource','lock_resource','set_rerolls','lock_rerolls','spawn_reward','open_sell_traits'):
            ...
            if command in ('set_resource','set_rerolls','spawn_reward','open_sell_traits','lock_resource','lock_rerolls'):
